 ...
 *
 * How to use:
 * when in design mode press what key "Classifier" is set to, (default is "?").
 * it will replace all names of your ships.
 */
 
(function () {
    var shipsClass, setFleetClasses, window_onkeydown_orig;
    ...
    shipClass.classifyShip = function () {
        ...
        if (u.weapons.length === 0) {
            ...
            if (has(["!Cloak Generator", "!Energy Transfer"])) {
                if (u.maxShield > 105) {
                    return ship_Name += "|" + u.maxShield + "| shield";
                }
            }
        ...
        if (u.speed < 200 && u.hp > 250) {
             ...
             * @class titan
             */
            else if (u.hp > 1800 && u.speed < 80) {
                if (u.weaponRange > 2200) {
                    type = "anti-titan titan";
                } else if (u.weaponRange > 1800) {
                    type = "titan";
                } 
            }
